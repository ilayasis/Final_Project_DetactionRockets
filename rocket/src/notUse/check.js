...
//   const pageSize = 3;
//   const urlFiles = "http://127.0.0.1:8000/get_files";
...
//     setVideoData(filename);

//     //const urlFirstFrame = `http://127.0.0.1:8000/get_first_video_frame?filename=${filename}`;
//     //navigate("/InvestigationVideo");
...
//       .replace(/(\d+)/g, "$1 ");
//     // const launchNumber = lastPart.replace("Launch", ""); // remove the "Launch" prefix from the last part
//     // console.log("launchNumber", launchNumber);
//     // const launchName = "Launch" + launchNumber.replace(".mp4", ""); // concatenate the "Launch" prefix with the launch number and remove the ".mp4" extension
//     // console.log("launchName", launchName);
//     // const last = launchName.replace("Missile", "");
//     return newName;
//   }
...
//                     <button
//                       onClick={() => {
//                         const videoName = getLaunchName(file.filename);
//                         handleClick(file.filename);
//                       }}
//                       className={css.buttonNmae}
//                     >
...
// import Spiner from "../../components/VideosPage/Spiner";
...
// import Rokcet from "../../components/VideosPage/Rocket";

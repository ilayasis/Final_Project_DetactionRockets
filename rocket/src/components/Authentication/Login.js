...
import identiefiy from "../../assets/identify.png";
...
const Login = () => {
  const { setToken, setAdmin, setUserName, token } =
  ...
  const handelChangeInputLogin = (e) => {
    setInputs((prev) => ({
      ...prev,
  ...
  let tokenStorage, adminStorage, usernameStorage, response;

  const handleSubmitButtonLogin = (e) => {
    e.preventDefault();
    response = false;
    axios
      .post("http://localhost:3005/api/login", inputs)
      .then((res) => {
        response = true;
        console.log("data about the user : ", res.data);
        localStorage.setItem("user", res.data.token);
        localStorage.setItem("admin", res.data.existingUser.isAdmin);
    ...
    <div className="login-box">
      ...
      <form>
        <div className="user-box">
          <input
            onChange={handelChangeInputLogin}
        ...
        <a href="#" onClick={handleSubmitButtonLogin}>
          <span></span>
          <span></span>
          <span></span>
          <span></span>
...
//     </div>
//     <form className={css.form} onSubmit={handleSubmit}>
//       <div className={css.verifyC}>
//         <p className={css.verify} id="verify">
//           Verify
//         </p>
//         {/* <img
//           src={identiefiy}
...
//       </div>
//       <div className={css.btn}>
//         <button onClick={handleSubmit} type="submit" className={css.button2}>
//           Log in
//         </button>
//       </div>
//     </form>
